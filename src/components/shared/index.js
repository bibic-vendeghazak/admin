...
export const Post = ({title, subtitle, primaryButtonLabel, primaryButtonClick, primaryButtonDisabled, secondaryButtonLabel, secondaryButtonClick, secondaryButtonDisabled, children}) => (
  <Card>
    <CardHeader {...{title, subtitle}} actAsExpander showExpandableButton/>
